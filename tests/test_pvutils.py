...
class TestPVUtils(unittest.TestCase):
    ...
    def test_angulo_diario(self):
        ...
        self.assertEqual(angulo_diario, 0.0)
        angulo_diario = pvu.angulo_diario(fecha2)
        self.assertEqual(angulo_diario, 3.115771344108233)
        angulo_diario = pvu.angulo_diario(fecha3)
        self.assertEqual(angulo_diario, 6.265971100858546)
    ...
    def test_ecc_del_tiempo(self):
        ...
        self.assertEqual(ecc_del_tiempo, -2.90416896)
        ecc_del_tiempo = pvu.ecc_del_tiempo(angulo_diario2)
        self.assertEqual(ecc_del_tiempo, -3.4623274857594577)
        ecc_del_tiempo = pvu.ecc_del_tiempo(angulo_diario3)
        self.assertEqual(ecc_del_tiempo, -2.453457770899547)
